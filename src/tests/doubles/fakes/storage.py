...
class FakeS3Storage(S3StorageInterface):
    ...
    def __init__(self):
        """
        Initializes the FakeS3Storage instance with an empty internal storage dictionary.
        """
        self.storage: Dict[str, bytes] = {}

    async def upload_file(self, file_name: str, file_data: Union[bytes, bytearray]) -> None:
        """
        Stores file data in the internal dictionary under the specified file name to simulate an S3 upload.
        
        Args:
            file_name: The name to associate with the stored file data.
    ...
    async def get_file_url(self, file_name: str) -> str:
        """
        Returns a simulated URL for the specified file stored in the fake S3 storage.
        
        Args:
            file_name: The name of the file.
        
        Returns:
            A fake URL string representing the file's location.
        """
