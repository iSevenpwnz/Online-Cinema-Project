...
class JWTAuthManagerInterface(ABC):
    ...
    def create_access_token(self, data: dict, expires_delta: Optional[timedelta] = None) -> str:
        """
        Generates a new JWT access token containing the provided data.
    ...
    def create_refresh_token(self, data: dict, expires_delta: Optional[timedelta] = None) -> str:
        """
        Generates a new refresh token containing the provided data and optional expiration.
        
        Args:
            data: The payload to include in the refresh token.
            expires_delta: Optional duration until the token expires.
    ...
    def decode_refresh_token(self, token: str) -> dict:
        ...
        Returns:
            The decoded payload of the refresh token.
        """
        pass
    ...
    def verify_refresh_token_or_raise(self, token: str) -> None:
        ...
        Raises:
            An error if the refresh token is invalid.
        """
        pass
    ...
    def verify_access_token_or_raise(self, token: str) -> None:
        ...
        Raises:
            An error if the access token is invalid or expired.
        """
        pass
