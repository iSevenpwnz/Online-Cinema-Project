...
class UserGroupModel(Base):
    ...
    def __repr__(self):
        """
        Returns a string representation of the UserGroupModel instance with its id and name.
        """
...
class UserModel(Base):
    ...
    def create(cls, email: str, raw_password: str, group_id: int | Mapped[int]) -> "UserModel":
        ...
        Initializes a UserModel with the provided email and group ID, hashes the raw password, and sets it securely on the user.
        """
    ...
    def password(self) -> None:
        ...
        This property is write-only to ensure that the password cannot be accessed in plaintext.
        """
    ...
    def password(self, raw_password: str) -> None:
        ...
        Args:
        	raw_password: The plaintext password to set for the user.
        """
...
class ActivationTokenModel(TokenBaseModel):
    ...
    def __repr__(self):
        """
        Returns a string representation of the activation token model with its ID, token, and expiration.
        """
...
class PasswordResetTokenModel(TokenBaseModel):
    ...
    def __repr__(self):
        """
        Returns a string representation of the password reset token model, including its ID, token, and expiration datetime.
        """
...
class RefreshTokenModel(TokenBaseModel):
    ...
    def create(cls, user_id: int | Mapped[int], days_valid: int, token: str) -> "RefreshTokenModel":
        ...
        Returns:
            A new RefreshTokenModel instance with the calculated expiration date.
        """
    ...
    def __repr__(self):
        """
        Returns a string representation of the refresh token model with its ID, token, and expiration.
        """
