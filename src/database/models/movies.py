...
class ActorModel(Base):
    ...
    def __repr__(self):
        """
        Returns a string representation of the actor, displaying the actor's name.
        """
...
class LanguageModel(Base):
    ...
    def __repr__(self):
        """
        Returns a string representation of the language, showing its name.
        """
...
class MovieModel(Base):
    ...
    def default_order_by(cls):
        ...
        Returns:
            A list containing the SQLAlchemy expression for descending order by the model's ID.
        """
        return [cls.id.desc()]
