...
def upgrade() -> None:
    ...
    """
    Creates all database tables, indexes, and constraints for the initial schema of the movie application.
    
    This includes tables for actors, countries, genres, languages, user groups, movies, users, activation tokens, password reset tokens, refresh tokens, user profiles, and association tables for many-to-many relationships. Constraints such as primary keys, unique constraints, foreign keys, and cascading deletes are established as defined in the schema.
    """
...
def downgrade() -> None:
    ...
    This function removes all entities related to actors, movies, users, tokens, and associated relationships, effectively undoing the changes made by the corresponding upgrade.
    """
