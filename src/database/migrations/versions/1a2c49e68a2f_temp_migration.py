...
Revision ID: 1a2c49e68a2f
Revises: 
Create Date: 2025-06-06 16:15:07.354046
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'movie_id', name='user_movie_like_unique')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'movie_id', name='user_movie_rating_unique')
    )
