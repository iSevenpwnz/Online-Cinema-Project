...
Revision ID: 42c9f40c484e
Revises: e719df11079c
Create Date: 2025-06-06 13:52:18.881305
...
revision: str = '42c9f40c484e'
down_revision: Union[str, None] = 'e719df11079c'
...
def upgrade() -> None:
    ...
    sa.Column('name', sa.Enum('GENERAL_AUDIENCE', 'PARENTAL_GUIDANCE_SUGGESTED', 'PARENTS_STRONGLY_CAUTIONED', 'RESTRICTED', 'ADULTS_ONLY', name='certificationenum'), nullable=False),
    ...
    op.add_column('movies', sa.Column('uuid', sa.String(length=100), nullable=False))
